...
C_DEPS += \
./lib/fatfs/source/diskio.d \
./lib/fatfs/source/ff.d \
./lib/fatfs/source/ffsystem.d \
./lib/fatfs/source/ffunicode.d 

OBJS += \
./lib/fatfs/source/diskio.o \
./lib/fatfs/source/ff.o \
./lib/fatfs/source/ffsystem.o \
./lib/fatfs/source/ffunicode.o 


# Each subdirectory must supply rules for building sources it contributes
lib/fatfs/source/%.o: ../lib/fatfs/source/%.c lib/fatfs/source/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lib-2f-fatfs-2f-source

clean-lib-2f-fatfs-2f-source:
	-$(RM) ./lib/fatfs/source/diskio.d ./lib/fatfs/source/diskio.o ./lib/fatfs/source/ff.d ./lib/fatfs/source/ff.o ./lib/fatfs/source/ffsystem.d ./lib/fatfs/source/ffsystem.o ./lib/fatfs/source/ffunicode.d ./lib/fatfs/source/ffunicode.o

.PHONY: clean-lib-2f-fatfs-2f-source
