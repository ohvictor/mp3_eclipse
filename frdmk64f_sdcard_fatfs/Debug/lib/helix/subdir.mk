...
lib/helix/%.o: ../lib/helix/%.c lib/helix/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-lib-2f-helix

clean-lib-2f-helix:
	-$(RM) ./lib/helix/mp3dec.d ./lib/helix/mp3dec.o ./lib/helix/mp3tabs.d ./lib/helix/mp3tabs.o

.PHONY: clean-lib-2f-helix
