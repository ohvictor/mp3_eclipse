...
C_SRCS += \
../source/FSYS/filesystem/filesystem.c 

C_DEPS += \
./source/FSYS/filesystem/filesystem.d 

OBJS += \
./source/FSYS/filesystem/filesystem.o 


# Each subdirectory must supply rules for building sources it contributes
source/FSYS/filesystem/%.o: ../source/FSYS/filesystem/%.c source/FSYS/filesystem/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-FSYS-2f-filesystem

clean-source-2f-FSYS-2f-filesystem:
	-$(RM) ./source/FSYS/filesystem/filesystem.d ./source/FSYS/filesystem/filesystem.o

.PHONY: clean-source-2f-FSYS-2f-filesystem
