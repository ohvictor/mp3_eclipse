...
C_SRCS += \
../source/FSYS/mp3decoder/mp3decoder.c 

C_DEPS += \
./source/FSYS/mp3decoder/mp3decoder.d 

OBJS += \
./source/FSYS/mp3decoder/mp3decoder.o 


# Each subdirectory must supply rules for building sources it contributes
source/FSYS/mp3decoder/%.o: ../source/FSYS/mp3decoder/%.c source/FSYS/mp3decoder/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-FSYS-2f-mp3decoder

clean-source-2f-FSYS-2f-mp3decoder:
	-$(RM) ./source/FSYS/mp3decoder/mp3decoder.d ./source/FSYS/mp3decoder/mp3decoder.o

.PHONY: clean-source-2f-FSYS-2f-mp3decoder
