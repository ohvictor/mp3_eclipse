...
C_SRCS += \
../source/LOGIC/evQueue.c \
../source/LOGIC/fsm_motor.c \
../source/LOGIC/fsm_states.c 

C_DEPS += \
./source/LOGIC/evQueue.d \
./source/LOGIC/fsm_motor.d \
./source/LOGIC/fsm_states.d 

OBJS += \
./source/LOGIC/evQueue.o \
./source/LOGIC/fsm_motor.o \
./source/LOGIC/fsm_states.o 


# Each subdirectory must supply rules for building sources it contributes
source/LOGIC/%.o: ../source/LOGIC/%.c source/LOGIC/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-LOGIC

clean-source-2f-LOGIC:
	-$(RM) ./source/LOGIC/evQueue.d ./source/LOGIC/evQueue.o ./source/LOGIC/fsm_motor.d ./source/LOGIC/fsm_motor.o ./source/LOGIC/fsm_states.d ./source/LOGIC/fsm_states.o

.PHONY: clean-source-2f-LOGIC
