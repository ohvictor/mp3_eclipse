...
C_SRCS += \
../source/LOGIC/audioplayer/audioplayer.c 

C_DEPS += \
./source/LOGIC/audioplayer/audioplayer.d 

OBJS += \
./source/LOGIC/audioplayer/audioplayer.o 


# Each subdirectory must supply rules for building sources it contributes
source/LOGIC/audioplayer/%.o: ../source/LOGIC/audioplayer/%.c source/LOGIC/audioplayer/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-LOGIC-2f-audioplayer

clean-source-2f-LOGIC-2f-audioplayer:
	-$(RM) ./source/LOGIC/audioplayer/audioplayer.d ./source/LOGIC/audioplayer/audioplayer.o

.PHONY: clean-source-2f-LOGIC-2f-audioplayer
