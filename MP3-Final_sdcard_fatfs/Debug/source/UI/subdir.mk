...
C_SRCS += \
../source/UI/controls.c \
../source/UI/vumeter.c 

C_DEPS += \
./source/UI/controls.d \
./source/UI/vumeter.d 

OBJS += \
./source/UI/controls.o \
./source/UI/vumeter.o 


# Each subdirectory must supply rules for building sources it contributes
source/UI/%.o: ../source/UI/%.c source/UI/subdir.mk
	@echo 'Building file: $<'
...
clean: clean-source-2f-UI

clean-source-2f-UI:
	-$(RM) ./source/UI/controls.d ./source/UI/controls.o ./source/UI/vumeter.d ./source/UI/vumeter.o

.PHONY: clean-source-2f-UI
